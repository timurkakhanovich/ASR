...
from ASR.modules.pipeline.constants import (
    BPEMB_EN,
    HID_SIZE,
    N_MELS,
    NUM_LAYERS,
...
from ASR.modules.pipeline.model_config import get_arguments
...
def main_command_line_args() -> None:
    ...
    data = set_split(batch_size=batch_size, train_shuffle=True, collator=collator)
    ...
    with wandb.init(project='ASR', entity='timkakhanovich', config=config) as run:
        ...
        model_artifact = wandb.Artifact('QuartzLM', type='model')
