...
class QuartzNet(nn.Module):
    def __init__(
        ...
        self.C3 = nn.Sequential(
            nn.Conv1d(
                in_channels=512, out_channels=1024, kernel_size=1, stride=1, dilation=1
            ),
...
class Decoder(nn.Module):
    def __init__(
        ...
        self.emb_out = nn.Embedding(
            num_embeddings=BPEMB_EN.vs, embedding_dim=BPEMB_EN.dim, padding_idx=PAD_IDX
        )
